...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> <a href="first.do" class="maincolor">首页</a> <span class="c-gray en">&gt;</span> 数据统计 <span class="c-gray en">&gt;</span> 销项分析 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>

<br>&nbsp;&nbsp;&nbsp;
<span class="select-box" style="width:150px">
    <select class="select" name="brandclass" size="1" id="year"></select></span>&nbsp;年&nbsp;&nbsp;&nbsp;
<button onclick = "TaxyearOfEachmonthPan()" class="btn btn-primary upload-btn">销项额饼状图</button>
<div id = "outtax"></div>
<div id = "intax"></div>
<script>
