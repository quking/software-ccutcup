...
<div class="Hui-article">
    <article class="cl pd-20">
        <form action="/search.do" method="post" onsubmit="return judge()">
            <div class="text-c">
                ...
                <button class="btn btn-success" type="submit"><i class="Hui-iconfont" onclick="checkNull()">&#xe665;</i> 查询</button>
            </div>
        </form>
    ...
    <div class="ep-pages">
        <a href="/search.do?page=${page.prePage}&category=${requestScope.category}&invoiceId=${requestScope.invoiceId}&invoiceCode=${requestScope.invoiceCode}&companyName=${requestScope.companyName}&startDate=${requestScope.startDate}&endDate=${requestScope.endDate}" target="_self" class="ep-pages-ctr1">共${page.pages}页</a>
        <a href="/search.do?page=${page.firstPage}&category=${requestScope.category}&invoiceId=${requestScope.invoiceId}&invoiceCode=${requestScope.invoiceCode}&companyName=${requestScope.companyName}&startDate=${requestScope.startDate}&endDate=${requestScope.endDate}" target="_self" class="ep-pages-ctrl">首页</a>
        <a href="/search.do?page=${page.prePage}&category=${requestScope.category}&invoiceId=${requestScope.invoiceId}&invoiceCode=${requestScope.invoiceCode}&companyName=${requestScope.companyName}&startDate=${requestScope.startDate}&endDate=${requestScope.endDate}" target="_self" class="ep-pages-ctrl">&lt;上一页</a>
        <a href="/search.do?page=${page.pageNum}&category=${requestScope.category}&invoiceId=${requestScope.invoiceId}&invoiceCode=${requestScope.invoiceCode}&companyName=${requestScope.companyName}&startDate=${requestScope.startDate}&endDate=${requestScope.endDate}" target="_self" class="current">第${page.pageNum}页</a>
        <a href="/search.do?page=${page.nextPage}&category=${requestScope.category}&invoiceId=${requestScope.invoiceId}&invoiceCode=${requestScope.invoiceCode}&companyName=${requestScope.companyName}&startDate=${requestScope.startDate}&endDate=${requestScope.endDate}" target="_self" class="ep-pages-ctrl">&gt;下一页</a>
        <a href="/search.do?page=${page.lastPage}&category=${requestScope.category}&invoiceId=${requestScope.invoiceId}&invoiceCode=${requestScope.invoiceCode}&companyName=${requestScope.companyName}&startDate=${requestScope.startDate}&endDate=${requestScope.endDate}" target="_self" class="ep-pages-ctrl">尾页</a>
    </div>
    <!--_footer 作为公共模版分离出去-->
